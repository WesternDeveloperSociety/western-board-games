"""
Django settings for westernBoardGames project.
...
SECRET_KEY = 'django-insecure-v_t=pc*zblvnn^!a(*28efu^mn5^2rm45g_7xfgiz51!sh@#le'
...
WSGI_APPLICATION = 'westernBoardGames.wsgi.application'
